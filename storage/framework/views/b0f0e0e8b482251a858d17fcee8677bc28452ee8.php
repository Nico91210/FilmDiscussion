...
<head>
  ...
  <link href = <?php echo e(asset('css/tw.css')); ?> rel = "stylesheet" />
        ...
        <a id="button_compte" class="inline-block text-gray-200" href="#">
          <li class="relative hover:bg-secondary py-2 px-2 focus:outline-none focus:shadow-outline rounded">
            ...
            <span class="inline ml-4">
              <?php if(Auth::check()): ?>
                <?php if(Auth::user()->notificationsNotRead()->count() > 0): ?>
                  <?php echo e(Auth::user()->username); ?> (<?php echo e(Auth::user()->notificationsNotRead()->count()); ?>)
                <?php else: ?>
...
</html><?php /**PATH C:\Nouveau dossier\filmdiscussion\resources\views/navbar.blade.php ENDPATH**/ ?>