            ...
            <div class="w-48 h-64 opacity-0 hover:opacity-100">
              ...
              <?php if($film->notes): ?>
                <div class="absolute py-2 px-2 bottom-0 text-button">
                  ...
                  <h2 class="inline text-gray-200 font-semibold text-lg"><?php echo e($film->notes); ?>/5</h2>
                </div>
              <?php endif; ?>
            </div>
          </div>
          <img class="text-gray-200 italic h-64 w-48 object-cover rounded-lg"
          src="<?php echo e(URL('/storage/'.$film->affiche)); ?>" alt="Affiche <?php echo e($film->titre); ?>"/>
        </a>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
</body><?php /**PATH C:\Nouveau dossier\filmdiscussion\resources\views/accueil.blade.php ENDPATH**/ ?>